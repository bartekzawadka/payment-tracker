...
docker cp payment-tracker-integration-tests:/app/Tests/Payment.Tracker.IntegrationTests/bin/Release/5.0/TestResults/IntegrationTestResults.trx $BUILD_SOURCESDIRECTORY